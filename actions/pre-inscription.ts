  ...
  try {
    const { data: inserted, error: dbError } = await supabase
      ...
      .insert({
        ...
        sante_asthme: data.santeAsthme,
        sante_cardiopathie: data.santeCardiopathie,
        sante_diabete: data.santeDiabete,
        sante_drepanocytose: data.santeDrepanocytose,
        sante_hta: data.santeHta,
        sante_epilepsie: data.santeEpilepsie,
        aptitude_sport: data.aptitudeSport ?? null,
      })
      .select("id")
      .single();

    ...
    etapes: [
      {
        ...
        description:
          "Remplissez le formulaire de pré-inscription sur notre site. C'est gratuit et sans engagement.",
      },
      {
        num: "02",
        title: "Contact de l'établissement",
        description:
          "Un responsable de l'école vous contacte par téléphone sous 48h pour confirmer la disponibilité et fixer un rendez-vous.",
      },
      {
        num: "03",
